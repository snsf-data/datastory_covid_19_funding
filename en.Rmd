...
__Coronavirus-related research funded by the Swiss National Science Foundation is successfully delivering fast and beneficial results.__

The coronavirus pandemic that we have been living with since early 2020 has highlighted the importance of scientific research. Since it was completely unknown until it struck, the virus had to be decoded quickly so that scientists could develop effective medicines and vaccines and establish what preventive measures needed to be taken. The Swiss National Science Foundation contributed to these efforts by funding various research projects. Here is an overview. 
...
*	A <a href="https://www.snf.ch/de/BZARkjTMtrt48Gcb/news/einfluss-von-grenz-und-schulschliessungen-auf-die-eindaemmung-des-coronavirus" target="_blank">statistical model</a> for measuring the impact of border and school closures  
*	The development of a <a href="https://www.snf.ch/de/IR4xqilNfvUoe4E7/news/modell-von-sars-cov-2-verbessert-forschung-und-entwicklung-von-medikamenten" target="_blank">non-contagious model of SARS-CoV-2</a> to improve research and drug development  
*	A <a href="https://www.snf.ch/de/6AywkKU0LqBlQ92j/news/long-covid-neue-studienergebnisse" target="_blank">cohort study</a> of 3,000 people, which revealed a correlation between the severity of infection and the onset of long Covid symptoms  
*	A method for quickly and cost-efficiently estimating the <a href="https://www.snf.ch/de/Mhz1a3piOEoSgb2B/news/mit-abwasser-schnell-und-kostenguenstig-zum-r-wert" target="_blank">reproduction rate</a> of coronavirus using wastewater  
*	New <a href="https://www.nfp78.ch/de/news/des-candidats-vaccins-suisses-entament-la-phase-d-etudes-cliniques/" target="_blank">Swiss vaccine candidates</a> developed as part of NRP 78 (<a href="https://www.snf.ch/de/XZ6J2kZHkf5aMROA/news/innovative-forschung-zu-neuen-impfstoffen" target="_blank">see also</a>)
...
However, this situation will change when the new National Research Programme <a href="https://www.nfp80.ch/en/" target="_blank">«$~$Covid-19 in Society$~$»</a> (NRP 80) is launched in 2022, since this NRP will primarily target the social sciences and humanities. The projects will be selected during summer 2022. 
...
<div class="plot-box">
<div class="plot-title">Number and percentage of Covid-related grant projects (total of `r nrow(covid_grants_df)`) per research discipline</div>
```{r, out.width="100%"}
...
Examining the most represented disciplines among the projects funded, it becomes clear that the top six of the seven disciplines receiving the largest amount of funding are in the life sciences. The data we have cover `r n_distinct(covid_grants_df$MainDisciplineLevel2_En)` different disciplines, but the majority of projects – a total of `r sum(seven_top)`, or `r round(sum(seven_top) / nrow(covid_grants_df) * 100)` \% – are in one of the seven most represented disciplines.
