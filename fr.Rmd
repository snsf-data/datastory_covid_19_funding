...
* Un <a href="https://www.snf.ch/de/BZARkjTMtrt48Gcb/news/einfluss-von-grenz-und-schulschliessungen-auf-die-eindaemmung-des-coronavirus" target="_blank">modèle statistique</a> qui a permis de mesurer l’impact des fermetures de frontières et d’écoles  
* La création d’un <a href="https://www.snf.ch/de/IR4xqilNfvUoe4E7/news/modell-von-sars-cov-2-verbessert-forschung-und-entwicklung-von-medikamenten" target="_blank">modèle non contagieux du SARS-CoV-2</a> pour améliorer la recherche et le développement de médicaments  
* Une <a href="https://www.snf.ch/de/6AywkKU0LqBlQ92j/news/long-covid-neue-studienergebnisse" target="_blank">étude de cohorte</a> (3000 personnes) qui a mis en évidence l’existence d’une corrélation entre la gravité de l’infection et l’apparition de symptômes du Covid long  
* Une méthode pour estimer rapidement et à moindre coût le <a href="https://www.snf.ch/de/Mhz1a3piOEoSgb2B/news/mit-abwasser-schnell-und-kostenguenstig-zum-r-wert" target="_blank">taux de reproduction</a> du coronavirus à partir des eaux usées  
* Des <a href="https://www.nfp78.ch/fr/news/des-candidats-vaccins-suisses-entament-la-phase-d-etudes-cliniques/" target="_blank">candidats vaccins suisses</a>, développés dans le cadres du PNR 78, entament la phase d’études cliniques (<a href="https://www.snf.ch/de/XZ6J2kZHkf5aMROA/news/innovative-forschung-zu-neuen-impfstoffen" target="_blank">voir aussi</a>)  
...
Cette donne est toutefois amenée à changer puisqu’un nouveau Programme national de recherche <a href="https://www.nfp80.ch/en/" target="_blank">«$~$Covid-19 et société$~$»</a> (PNR 80) démarre en 2022. Ce PNR s’adresse principalement aux sciences humaines et sociales. Les projets seront sélectionnés au cours de l’été 2022. 
...
Si l’on analyse maintenant les disciplines les plus fréquentes dans les projets financés, on observe que les six premières disciplines sur les sept ayant le montant le plus élevé de financement relèvent des sciences de la vie. Les données dont nous disposons englobent un total de `r n_distinct(covid_grants_df$MainDisciplineLevel2_En)` disciplines différentes, mais nous constatons que la majorité des projets, `r sum(seven_top)` au total (`r round(sum(seven_top) / nrow(covid_grants_df) * 100)` \%), relèvent de l'une des sept disciplines les plus fréquentes.
