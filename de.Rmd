...
__Der Schweizerische Nationalfonds unterstützt Forschung zum Coronavirus. Mit Erfolg: Bereits liegen relevante Ergebnisse vor.__

Die Corona-Epidemie, mit der wir seit Anfang 2020 konfrontiert sind, hat einmal mehr gezeigt, wie wichtig Forschung ist. Für wirksame Medikamente, Impfstoffe und Präventionsmassnahmen musste das noch unbekannte Virus möglichst rasch entschlüsselt werden. Der Schweizerische Nationalfonds leistete einen Beitrag dazu, indem er vielfältige Forschungsprojekte finanzierte. Ein Überblick. 
...
* Die Entwicklung <a href="https://www.nfp78.ch/de/news/des-candidats-vaccins-suisses-entament-la-phase-d-etudes-cliniques/" target="_blank">Schweizer Impfstoffkandidaten</a> im Rahmen des NFP 78 (<a href="https://www.snf.ch/de/XZ6J2kZHkf5aMROA/news/innovative-forschung-zu-neuen-impfstoffen" target="_blank">siehe auch</a>)


### Lebenswissenschaften an der Spitze der Rangliste
...
Zudem wird sich dieser Trend mit dem 2022 lancierten Nationalen Forschungsprogramm <a href="https://www.nfp80.ch/en/" target="_blank">«$~$Covid-19 und Gesellschaft$~$»</a> (NFP 80) ändern. Dieses NFP richtet sich vor allem an die Geistes- und Sozialwissenschaften. Die Projekte werden im Laufe des Sommers 2022 ausgewählt. 
...
<div class="plot-box">
<div class="plot-title">Gesamtbetrag der bewilligten Mittel (in Schweizer Franken) für die `r n_applications`, Projekte zu Covid-19 nach Forschungsbereich</div>
...
Die folgende Abbildung zeigt die Anzahl und den Anteil der Projekte der einzelnen Disziplinen bei der Forschung zum Coronavirus. Auch hier dominieren gewisse Disziplinen. Die Präventivmedizin steht wenig überraschend zuoberst auf der Rangliste. Danach folgt die biologische Grundlagenforschung, wo es in den meisten Projekten darum geht, das Virus besser zu verstehen. Einige Projekte aus den Geistes- und Sozialwissenschaften befassen sich hingegen mit den Reaktionen der Gesellschaft und mit den Folgen der Pandemie. 

<div class="plot-box">
<div class="plot-title">Anzahl und Anteil von Projekten zu Covid (insgesamt `r nrow(covid_grants_df)`) in den einzelnen Disziplinen</div>
...
Eine Analyse der häufigsten Disziplinen bei den geförderten Projekten ergibt, dass die ersten sechs der sieben Disziplinen mit dem höchsten Förderbetrag aus dem Bereich der Lebenswissenschaften stammen. Daten liegen für `r n_distinct(covid_grants_df$MainDisciplineLevel2_En)` verschiedene Disziplinen vor, die Mehrheit der Projekte, nämlich `r sum(seven_top)` bzw. `r round(sum(seven_top) / nrow(covid_grants_df) * 100)`\%, stammt jedoch aus einer der sieben häufigsten Disziplinen.

Grundlagenforschung ist teuer: Am meisten Mittel – nämlich `r round(sum(covid_grants_df %>% filter(MainDisciplineLevel2_En == "Basic Biological Research") %>% pull(AmountGranted)) / 1000000, 1)` Millionen Franken – flossen in die biologische Grundlagenforschung. 

<div class="plot-box">
<div class="plot-title">Bewilligter Gesamtbetrag (in Schweizer Franken) für Forschungsprojekte in den sieben häufigsten Disziplinen</div>
...
Alle Forschungsprojekte zum Coronavirus in Verbindung werden in <a href="https://data.snf.ch/covid-19" target="_blank">einem Register</a> erfasst. 
